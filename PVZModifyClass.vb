...
#Region "修改功能"
    ...
    Public Shared Function JumpLevel(advLevel As Integer, gameLevel As Byte) As String
    ...
    Public Shared Sub AutoCollect(Optional ByVal Switch As Boolean = True)
        If Switch Then
            For Each coin In AllCoins
                If coin.Type = 4 Or coin.Type = 5 Or coin.Type = 6 Or coin.Type = 1 Or coin.Type = 2 Or coin.Type = 3 Then
                    coin.Collect()
                End If
            Next
    ...
    ''' 下雨天
    ''' </summary>
    Public Shared Sub Raining(Optional ByVal Switch As Boolean = True)
        If Switch Then
    ...
    Public Shared Sub ZombieQuick(Speed As Integer)
        Select Case Speed
            Case 1 '正常
